    ...
    <main class="main">
        <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
            <div class="container d-flex align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ asset('index.html') }}">Trang chủ</a></li>
                            ...
                            <div class="product-gallery product-gallery-separated">
                                ...
                                <figure class="product-separated-item">
                                    <img src="{{ asset($product->image2) }}"
                                        data-zoom-image="{{ asset('assets/images/products/single/sticky/2-big.jpg') }}"
                                        alt="product image">
                                </figure>

                                <figure class="product-separated-item">
                                    <img src="{{ asset($product->image3) }}"
                                        data-zoom-image="{{ asset('assets/images/products/single/sticky/3-big.jpg') }}"
                                        alt="product image">
                                </figure>

                                <figure class="product-separated-item">
                                    <img src="{{ asset($product->image4) }}"
                                        data-zoom-image="{{ asset('assets/images/products/single/sticky/4-big.jpg') }}"
                                        alt="product image">
                                </figure>
                        ...
                        <figure class="product-media">
                            ...
                            <div class="product-action-vertical">
                                <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to
                                        wishlist</span></a>
                                <a href="{{ asset('popup/quickView.html') }}" class="btn-product-icon btn-quickview"
